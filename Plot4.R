plot4<-function()
{
  ...
  with(ActivePower, plot(Global_active_power ~ datetime, type = "l",
                   ylab = "Global active power (kilowatts)", xlab = NA))
  
  with(ActivePower, plot(Voltage ~ datetime, type = "l",
                   ylab = "Voltage"))
  
  with(ActivePower, plot(Sub_metering_1 ~ datetime, type = "n", 
                         ylab = "Energy sub metering",xlab = NA))
  lines(ActivePower$datetime,ActivePower$Sub_metering_1,col = "black")
  lines(ActivePower$datetime,ActivePower$Sub_metering_2,col = "red")
  lines(ActivePower$datetime,ActivePower$Sub_metering_3,col = "blue")
  legend("topright", 
         legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), 
         lty = c(1,1,1), col = c("black", "red", "blue"))
  
  with(ActivePower, plot(Global_reactive_power ~ datetime, type = "l",
